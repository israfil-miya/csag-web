      ...
      <div className="max-w-5xl mx-auto">
        <header className="text-center mb-16 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Terms <span className="text-csag-primary">&amp; Conditions</span>
          </h1>
        ...
        <div className="prose prose-gray max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:leading-relaxed prose-li:leading-relaxed">
          <h2 className="text-xl font-semibold mt-8 mb-4">
            Welcome to Child Survival Aid Ghana (CSAG)
          </h2>
          <p>
            Child Survival Aid Ghana stands as a non-profit non-governmental
            organization with a mission to uplift the education of
            underprivileged children in Ghana. Our core dedication lies in
            furnishing rural children with top-notch education and resources,
            fostering an environment where they can blossom to their fullest
            potential. We firmly believe that every child, irrespective of their
            background or location, deserves the right to education. Rooted in
            this belief, we are resolute in steering positive transformation
          ...
          <p>
            ...
            conditions. Do not continue to use Child Survival Aid Ghana if you
          ...
          <h3 className="text-lg font-semibold mt-10 mb-3">Cookies</h3>
          <p>
          ...
          <p>
            Unless otherwise stated, Child Survival Aid Ghana and/or its
            licensors own the intellectual property rights for all material on
            Child Survival Aid Ghana Site. All intellectual property rights are
            reserved. You may access this from Child Survival Aid Ghana for your
            own personal use subjected to restrictions set in these terms and
            conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc pl-6 mt-2">
            <li>Republish material from Child Survival Aid Ghana</li>
            <li>
              Sell, rent or sub-license material from Child Survival Aid Ghana
            </li>
            <li>
              Reproduce, duplicate or copy material from Child Survival Aid
              Ghana
            </li>
            <li>Redistribute content from Child Survival Aid Ghana</li>
          </ul>
          <p className="mt-6">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            Child Survival Aid Ghana does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Child Survival Aid Ghana, its
            ...
            permitted by applicable laws, Child Survival Aid Ghana shall not be
          ...
          <p>
            Child Survival Aid Ghana reserves the right to monitor all Comments
          ...
          <p className="mt-6">
            You hereby grant Child Survival Aid Ghana a non-exclusive license to
          ...
          <p className="mt-6">
            ...
            visibility of the hyperlink compensates the absence of Child
            Survival Aid Ghana; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Child Survival Aid Ghana. Please include your
          ...
          <h3 className="text-lg font-semibold mt-10 mb-3">Your Privacy</h3>
          ...
          <h3 className="text-lg font-semibold mt-10 mb-3">Disclaimer</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold mt-10 mb-3">Contact</h3>
          <p>
            Please contact us if you have any question or concerns. Our contact
            details are as follows:
            <br /> P. O. Box TN 1661, Teshie-Nungua Estate
            <br />
            E-mail:{" "}
            <a
