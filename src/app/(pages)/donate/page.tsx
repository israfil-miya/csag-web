...
const GLOBAL_GIVING_URL =
  "https://www.globalgiving.org/projects/empower-a-child-through-education-in-rural-ghana/";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 animate-fade-in">
          <div>
            ...
            <p className="text-gray-700 text-base md:text-lg leading-relaxed mt-6">
              ...
              at Child Survival Aid Ghana, P.O.Box TN1661, Teshie-Nungua Estate.
              Accra Ghana
            </p>
            ...
            <div className="relative overflow-hidden rounded-minimal border border-gray-200 bg-white p-6">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  ...
                  children in rural communities of Ghana. Driven by an
        ...
        <section className="mb-16 animate-slide-up" id="ways-to-get-involved">
          ...
          <p className="text-gray-700 mb-6">
            OTHER WAYS YOU CAN SUPPORT CHILD SURVIVAL AID GHANA
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-gray-800">
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>
                  <span className="font-semibold">Account Name:</span> Child
                  Survival Aid Ghana
                </p>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                <ShieldCheck className="h-5 w-5 mt-0.5 text-csag-primary" />
                <p>
                  <span className="font-semibold">SWIFT CODE:</span>{" "}
                  <span className="font-mono tracking-wide">GTBIGHAC</span>
                </p>
              </div>
              <div className="flex items-start gap-3">
                <ShieldCheck className="h-5 w-5 mt-0.5 text-csag-primary" />
                <p>
                  ...
                  <span className="font-mono tracking-wide">230108</span>
                </p>
              </div>
            </div>
          </div>
