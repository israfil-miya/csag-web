...
export default function SponsorSection() {
  return (
    <div className="py-24 px-4 md:px-8 bg-linear-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16 animate-fade-in">
          ...
          <div className="w-24 h-1 bg-linear-to-r from-csag-primary to-csag-accent mx-auto mb-8 rounded-minimal" />
        ...
        <div className="animate-fade-in" style={{ animationDelay: "0.15s" }}>
          ...
          >
            {supporters.slice(0, 6).map((p, i) => (
              <div
                key={p.name}
                className="group relative bg-linear-to-br from-white to-gray-50 border border-gray-100 rounded-lg p-4 flex items-center justify-center h-28 hover:border-csag-primary/30 transition-all duration-300 hover:-translate-y-0.5"
