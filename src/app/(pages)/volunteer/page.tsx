        ...
        <div className="relative px-4 md:px-8 pt-28 pb-20">
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <p className="mt-6 text-white/90 leading-relaxed text-lg md:text-xl">
              Join Child Survival Aid Ghana in empowering young people through
      ...
      <div className="px-4 md:px-8 py-14 bg-gray-50" id="programs">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="mt-10 text-gray-600 text-sm">
            At Child Survival Aid Ghana, we value diversity and inclusion,
      ...
      {/* <div className="px-4 md:px-8 py-16 bg-white ">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 divide-y divide-gray-200 border border-gray-200 rounded-lg overflow-hidden">
            {[
              {
                q: "What is the mission of Child Survival Aid Ghana (CSAG)?",
                a: "CSAG advances education, health, and wellbeing for children and communities in Ghana through programs, partnerships, and advocacy.",
              },
              {
                q: "How does CSAG support education in Ghana?",
              ...
              {
                q: "What healthcare projects does CSAG undertake?",
              ...
              {
                q: "How can I donate or support CSAG?",
                a: "You can donate via our Donate page, partner with us, or volunteer your time and skills.",
              },
              {
                q: "Can I volunteer with CSAG?",
                a: "Yes. Use the registration form above to apply, and our team will follow up with you.",
              },
              {
                q: "What communities does CSAG work with?",
                a: "We work with underserved and rural communities across Ghana, focusing on areas with the greatest need.",
              },
            ].map((item, idx) => (
