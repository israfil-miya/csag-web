    ...
    <section className="py-24 px-4 md:px-8 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-csag-primary to-csag-accent p-8 rounded-lg text-white">
            <h3 className="text-2xl font-bold mb-4">Become Our Partner</h3>
            <p className="text-lg mb-6 opacity-95">
              Join us in our mission to provide quality education to children in
              rural Ghana.
            </p>
            <Link
              href="/partnership"
